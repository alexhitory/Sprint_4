...
@RunWith(Parameterized.class)
    public class ScooterOrderChromeTest {
        ...
        public ScooterOrderChromeTest (String name, String family, String address, String telephone, String date, String comment) {
    ...
    public void OrderChromeTestBottomButton() {
        //Прокрутка и нажатие на кнопку заказать внизу страницы
        new MainPage(driver)
