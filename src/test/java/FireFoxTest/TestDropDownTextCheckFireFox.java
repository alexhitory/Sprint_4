...
public class TestDropDownTextCheckFireFox {
        ...
        public TestDropDownTextCheckFireFox(int locationFaq, int hiddenFaqText, String expectedText) {
        ...
        @Test
        public void TestDropDownCheckSs() {
            new MainPage(driver)
